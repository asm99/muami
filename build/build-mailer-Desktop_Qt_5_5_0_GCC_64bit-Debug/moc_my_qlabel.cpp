...
QT_MOC_LITERAL(1, 10, 10), // "mouseHover"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 13), // "mouseNotHover"
QT_MOC_LITERAL(4, 36, 10) // "mouseClick"

    },
    "my_qlabel\0mouseHover\0\0mouseNotHover\0"
    "mouseClick"
};
...
void my_qlabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mouseHover(); break;
        case 1: _t->mouseNotHover(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&my_qlabel::mouseHover)) {
                *result = 0;
            }
        }
        {
            typedef void (my_qlabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&my_qlabel::mouseNotHover)) {
                *result = 1;
            }
        }
        {
            typedef void (my_qlabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&my_qlabel::mouseClick)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void my_qlabel::mouseHover()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void my_qlabel::mouseNotHover()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void my_qlabel::mouseClick()
{
